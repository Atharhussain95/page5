    ...
    const revealTexts = () => {
        gsap.fromTo(texts, {
            ...
            scrollTrigger: {
                ...
                onEnter: debounce(() => console.log('Entering page1 texts section'), 200),
                onLeave: debounce(() => console.log('Leaving page1 texts section'), 200),
                onEnterBack: debounce(() => console.log('Entering page1 texts section again while scrolling up'), 200),
                onLeaveBack: debounce(() => console.log('Leaving page1 texts section while scrolling up'), 200),
            }
        });
    };
    ...
    const revealImage = () => {
        gsap.fromTo(image, {
            ...
            scrollTrigger: {
                ...
                toggleActions: "play reverse play reverse",
                onEnter: debounce(() => console.log('Entering page1 image section'), 200),
                onLeave: debounce(() => console.log('Leaving page1 image section'), 200),
                onEnterBack: debounce(() => console.log('Entering page1 image section again while scrolling up'), 200),
                onLeaveBack: debounce(() => console.log('Leaving page1 image section while scrolling up'), 200),
            }
        });
    };
...
function page4() {
    ...
    const tl = gsap.timeline({
        scrollTrigger: {
            trigger: "#page4",
            start: "top 80%", // Start when #page4 comes into view
            end: "bottom 20%",
            toggleActions: "play none none reverse",
        }
    });
    ...
    tl.from("#page4 .stext", {
        ...
        y: 100, 
        opacity: 0, 
        stagger: 0.3, // Stagger reveal for each .stext
        ease: "power2.out"
    });
}
